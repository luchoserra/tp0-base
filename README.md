...
## Guía de ejecución y detalles de implementación
...
- `<OUTPUT_FILE>` es el nombre que recibirá el archivo a generar
- `<NUMBER_OF_CLIENTS>` es la cantidad de clientes a generar
